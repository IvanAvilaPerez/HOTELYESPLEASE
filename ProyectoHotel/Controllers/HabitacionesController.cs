...
namespace ProyectoHotel.Controllers
{
    public class HabitacionesController : Controller
    {
        ...
        public HabitacionesController(HotelYesPleaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Habitaciones != null ? 
                          ...
                          Problem("Entity set 'HotelYesPleaseContext.Habitaciones'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdHabitacion,TipoHabitacion,PrecioNoche,Capacidad,Estado")] Habitacione habitacione)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdHabitacion,TipoHabitacion,PrecioNoche,Capacidad,Estado")] Habitacione habitacione)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HotelYesPleaseContext.Habitaciones'  is null.");
            }
            var habitacione = await _context.Habitaciones.FindAsync(id);
            if (habitacione != null)
            {
